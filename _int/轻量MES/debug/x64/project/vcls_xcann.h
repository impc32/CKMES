...
public:
    ...
    INT rg_button_DianJi (INT64 rg_AnNiuGouBing, rg_volcano_base::rg_LuoJiXingLei& rg_ShiFouLanJie80);
    INT rg_button_XuanZhong (INT64 rg_AnNiuGouBing1, BOOL rg_ShiFouXuanZhong, rg_volcano_base::rg_LuoJiXingLei& rg_ShiFouLanJie81);
    virtual void rg_YiChuShiJian1 (INT rg_ShiJianLeiXing16);
    virtual INT64 rg_ChuangJian7 (INT rg_ZuoBian33, INT rg_DingBian33, INT rg_KuanDu31, INT rg_GaoDu31, CVolString& rg_BiaoTi7, INT64 rg_FuGouBing5);
    inline_ xcann () { }
