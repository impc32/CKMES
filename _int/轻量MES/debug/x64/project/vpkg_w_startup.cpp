...
BOOL rg_ChuangKouChengXuLei::rg_XiaoXiGuoLu (INT64 rg_ChuangKouGouBing2, INT rg_XiaoXiZhi, INT64 rg_XiaoXiCanShu, INT64 rg_XiaoXiCanShu1, INT64 rg_XiaoXiDeZhi)
{
    return (TRUE);
}
